...
namespace Student_information.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SubId,name")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SubId,name")] Subject subject)
        {
            if (id != subject.SubId)
            {
                return NotFound();
        ...
        {
            return _context.Subject.Any(e => e.SubId == id);
        }
    }
}
